...
from src.etl.load.load_product import ProductLoader
from src.etl.load.load_seller import SellerLoader
from src.etl.load.load_geolocation import GeolocationLoader
from src.etl.load.load_product_category_translation import (
    ProductCategoryTranslationLoader,
)
from src.etl.load.load_orders import OrdersLoader
from src.etl.load.load_order_items import OrderItemsLoader
from src.etl.load.load_order_payments import OrderPaymentsLoader
from src.etl.load.load_order_reviews import OrderReviewsLoader
