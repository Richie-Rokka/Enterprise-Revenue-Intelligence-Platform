...
Module      : seller_transformer.py
Package     : src.etl.transform
Purpose     : Enterprise Seller Transformer
Author      : ERIP
Version     : 3.2.0

Description
-----------
Transforms raw seller data into a standardized dataset suitable
...
class SellerTransformer(BaseTransformer):
    ...
    def transform(
        ...
        logger.info(
            "Starting Seller transformation..."
        )
        ...
        logger.info(
            ...
            "Seller transformation completed "
    ...
    def _convert_zip_code(
        ...
        dataframe["seller_zip_code_prefix"] = (
